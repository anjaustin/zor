// =============================================================================
// 128x128x128 = 2,097,152 NODES - 21D Hypercube
...
// 32-bit maximal LFSR (taps: 32, 22, 2, 1) + Second Star mixing
...
int main() {
    printf("╔═══════════════════════════════════════════════════════════════════╗\n");
    printf("║     128×128×128 = 2,097,152 NODES (21D Hypercube)                 ║\n");
    printf("║     Second Star Constant Seed: %u                        ║\n", SECOND_STAR);
    printf("╚═══════════════════════════════════════════════════════════════════╝\n\n");
    ...
    printf("Threshold: %d | LFSR: 32-bit with Second Star mixing\n\n", THRESHOLD);
    ...
    for (int c = 0; c < max_cyc; c++) {
        ...
        if (c % 100 == 0 || c < 10 || h_res == NUM_NODES)
        ...
        if (h_res == NUM_NODES) {
            ...
            printf("  2097152 nodes(21D) → %d cycles\n", c);
            break;
        }
    }
    ...
    if (h_res < NUM_NODES) {
        ...
        printf("Time: %.1f ms | Total rewires: %d\n", ms, total_rew);
    }
