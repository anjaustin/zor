// =============================================================================
// 512x512x512 = 134,217,728 NODES - 27D Hypercube
...
// Use 64-bit atomics for large counts
...
int main() {
    printf("╔═══════════════════════════════════════════════════════════════════╗\n");
    printf("║     512×512×512 = 134,217,728 NODES (27D Hypercube)               ║\n");
    ...
    if (node_mem + state_mem > free_mem) {
    ...
    for (int c = 0; c < max_cyc; c++) {
        ...
        if (c % 500 == 0 || c < 10 || h_res == NUM_NODES)
        ...
        if (h_res == NUM_NODES) {
            ...
            printf("\n╔═══════════════════════════════════════════════════════════════════╗\n");
            printf("║     134,217,728 NODES CONVERGED at cycle %d                     ║\n", c);
            printf("╚═══════════════════════════════════════════════════════════════════╝\n");
            ...
            printf("  134217728 nodes(27D)→ %d cycles\n", c);
            break;
        }
    }
